                ...
                {routes.map(route => (
                    <Link
                        ...
                        className={buttonVariants({
                            variant: route.href === activeRoute.href ? 'siderbarActiveItem' : 'siderBarItem'
                        })}
                    >
                        <route.icon size={20} />
                        {route.label}
...
export function MobileSideBar() {
    ...
    return <div className='block border-separate
    bg-background md:hidden'>
        ...
        px-8'>
            <Sheet open={isOpen} onOpenChange={setOpen}>
                ...
                <SheetContent className='w-[400] sm:w-[540px] space-y-4'
                    side={"left"}>
                    <Logo />
